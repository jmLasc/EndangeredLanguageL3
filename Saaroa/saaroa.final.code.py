...
def transcribe_lines():
    with open("saaroa_stripped(3.0).txt", "r") as input_file:
    ...
    with open("saaroa_stripped_final.txt", "w") as output_file:
        for line in output_lines:
            output_file.write(line + "\n")

#4.26 code
read_pdf_text('saaroa.pdf', 'saaroa_stripped.txt')

#6.9 code 
read_text_file('saaroa_stripped.txt', 'saaroa_stripped(1.0).txt')

#6.12 & 6.13 code 
input_file = "saaroa_stripped(1.0).txt"
output_file_1 = "saaroa_stripped(2.0).txt"
output_file_2 = "saaroa_stripped(3.0).txt"
