...
def remove_star(lines):
    ...
    def filter_function(line):
        return "★" not in line and not re.search(r'(\bhttps://e-dictionary.ilrdf.org.tw\b)|([\u4e00-\u9fff]*拉阿魯哇語[\u4e00-\u9fff]*)', line)
...
read_pdf_text('saaroa.pdf', 'saaroa_stripped.txt', 'saaroa_filtered2.txt')
