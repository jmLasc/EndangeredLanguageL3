...
def remove_star(lines):
    ...
    def filter_function(line):
        return "★" not in line and not re.search(r'(\bhttps://e-dictionary.ilrdf.org.tw\b)|([\u4e00-\u9fff]*賽夏語[\u4e00-\u9fff]*)', line)
...
read_pdf_text('saisiyat.pdf', 'saisiyat_stripped.txt', 'saisiyat_filtered2.txt')
