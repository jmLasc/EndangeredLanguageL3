...
def remove_star(lines):
    return [line for line in lines if "★" not in line and not re.search(r'(\bhttps://e-dictionary.ilrdf.org.tw\b)|([\u4e00-\u9fff]*布農語[\u4e00-\u9fff]*)', line)]
...
def transcribe_lines():
    with open("bunun_stripped(3.0).txt", "r") as input_file:
    ...
    with open("bunun_stripped_final.txt", "w") as output_file:
        for line in output_lines:
            output_file.write(line + "\n")

#4.26 code
read_pdf_text('bunun.pdf', 'bunun_stripped.txt')

#6.9 code 
read_text_file('bunun_stripped.txt', 'bunun_stripped(1.0).txt')

#6.12 & 6.13 code 
input_file = "bunun_stripped(1.0).txt"
output_file_1 = "bunun_stripped(2.0).txt"
output_file_2 = "bunun_stripped(3.0).txt"
...
#                 elif should_log:
#                     if line:
#                         # Delete the American period that comes after the Chinese period
...
#         elif current_line:
#             # Delete the American period that comes after the Chinese period
#             current_line = re.sub(r'(?<=[\u4e00-\u9fff])\.\s*$', '', current_line)
#             output_lines.append(current_line.strip())
#             current_line = ""
