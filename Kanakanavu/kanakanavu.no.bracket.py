...
# Example usage
remove_brackets("kanakanavu_stripped_final.txt", "kanakanavu_stripped_no_bracket.txt")
add_newlines("kanakanavu_stripped_no_bracket.txt", "kanakanavu_stripped_no_bracket_final.txt")