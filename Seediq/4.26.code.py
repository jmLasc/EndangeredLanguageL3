...
def remove_star(lines):
    ...
    def filter_function(line):
        return "★" not in line and not re.search(r'(\bhttps://e-dictionary.ilrdf.org.tw\b)|([\u4e00-\u9fff]*賽德克語[\u4e00-\u9fff]*)', line)
...
read_pdf_text('seediq.pdf', 'seediq_stripped.txt', 'seediq_filtered2.txt')
