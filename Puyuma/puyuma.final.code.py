...
def remove_star(lines):
    return [line for line in lines if "★" not in line and not re.search(r'(\bhttps://e-dictionary.ilrdf.org.tw\b)|([\u4e00-\u9fff]*卑南語[\u4e00-\u9fff]*)', line)]
...
##    with open("puyuma_stripped(3.0).txt", "r") as input_file:
...
#4.26 code
read_pdf_text('puyuma.pdf', 'puyuma_stripped.txt')

#6.9 code 
read_text_file('puyuma_stripped.txt', 'puyuma_stripped(1.0).txt')

#6.12 & 6.13 code 
input_file = "puyuma_stripped(1.0).txt"
output_file_1 = "puyuma_stripped(2.0).txt"
output_file_2 = "puyuma_stripped(3.0).txt"
